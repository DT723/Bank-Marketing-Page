...
btnScrollTo.addEventListener('click', function (e) {
  ...
  //Older way to scroll - still used
  // window.scrollTo({
...
//////////////////////////////////
//Page Navigation
///Same function attached to all 3 elements - NOT efficient if we have lots more elements
...
///Usiong Event Delegation to make page navigation above more efficient
//Need 2 steps.
...
tabsContainer.addEventListener('click', function (e) {
  ...
  //Activate content in tab container
...
// Sticky nav: Inersection Observer API
...
const imgObserver = new IntersectionObserver(loadImg, {
  root: null,
  threshold: 0,
  //to add more affect to lazy load try '-200px';
  rootMargin: '200px',
});
...
///Styles with CSS custom properties or variables
...
// logo.setAttribute('company', 'BankMe');
